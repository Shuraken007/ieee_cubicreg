...
if __name__ == '__main__':
    ...
    steptype = 'poly'
    m_file = '..\\result\\' + 'cr_3_node_' + steptype + '.txt'
    ...
    start = time.time()
    cr = src.cubic_reg.CubicRegularization(x0, f, grad, hess, conv_tol=1e-10, L0=0.1, print_data=easy, stepmin = steptype, epsilon=0.0001)
